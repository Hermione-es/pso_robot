...
from 	robot_class_shortest import *
import	smach
import  smach_ros
import  time
import  os
...
class Go2Point(smach.State):
	...
	def execute(self, userdata):
			...
			if r.euclidean_distance(goal)>2:
				...
				goal_angular_speed=r.angular_vel(goal_point)

				goal_linear_speed = r.linear_vel(goal_point) #linear_vel 
				obst_angular_speed=r.get_apf_vel(goal_point) #get_apf_vel 
